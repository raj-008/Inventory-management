  ...
  <React.Fragment>
    <CardContent>
      ...
      <div sx={{ my: 1.5 }} color="text.secondary" className="form-container">
        <form>
          <TextField id="outlined-basic" className="contact-input" name="name" style={{ width: "100%" }} label="Name" variant="filled" />
          <TextField id="outlined-basic" className="contact-input contact-email" name="email" style={{ width: "100%" }} label="Email" variant="filled" />

          <TextField id="outlined-basic" className="contact-input contact-phone" name="phone" style={{ width: "100%" }} label="Phone" variant="filled" />
        ...
        <div className="contact-details">
          <div className="contact-conent">
            ...
            <div className="contact-item location">
              ...
              A1 HarekrishnaSociety, Surat395010
            </div>
